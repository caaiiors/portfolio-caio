...
(function setupI18n() {
  const translations = {
    ...
    en: {
      ...
      heroSubtitle: "Developer · UI/UX",
      heroBtnProjects: "View Projects",
      heroBtnContact: "Get in touch",
      aboutTitle: "About me",
      aboutText:
        "My name is Caio Rissa Silveira and I'm from Rio Grande do Sul, Brazil. I'm a front-end developer who loves clean interfaces, subtle animations, and strong visual experiences.",
      skillsTitle: "Skills",
